...
export default function Event() {
    ...
    const [displayObj, setDisplayObj] = useState({
            ...
            thumbnail:"http://res.cloudinary.com/dxjfmwr5n/image/upload/v1715971231/discover716/deepthi-clicks-cHtAYlpO1do-unsplash.jpg.jpg",
                ...
                <div id="display-intro" className="center">
                    ...
                    <div id="display-details-cont" className="center">
                        ...
                        <div id="display-details">
                            <p id="date">Date: {displayObj.date}</p>
                            <p id="time">Time: {formatTime(displayObj.startTime)} - {formatTime(displayObj.endTime)}</p>
